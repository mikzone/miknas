...
module.exports = configure(function (/* ctx */) {
  return {
    ...
    build: {
      ...
      alias: {
        // miknas_extensions: path.join(
        //   __dirname,
        //   './src/miknas/miknas_extensions'
        // ),
        // quasar_miknas: path.join(__dirname, './src/miknas/quasar_miknas'),
        miknas: path.join(__dirname, './src/miknas'),
      },
